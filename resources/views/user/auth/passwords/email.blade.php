                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    @endif
                                    <form class="mt-4" action="{{ route('user.password.email') }}" method="POST">
                                        @csrf
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Remember It ? <a href="{{ route('user.login') }}"
                                    ...
                                    <div id="reviewcarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <div class="testi-contain text-center text-white">
                                                    <i class="bx bxs-quote-alt-left text-success display-6"></i>
                                                    <h4 class="mt-4 fw-medium lh-base text-white">“Wow, rubic has shocked me
                                                        again with another blessing of NGN260,500 and I wish I had known, I
                                                        would have long join goldmint.abeg make una come follow me chop this
                                                        money from rubic ohhh.”</h4>
                                                    <div class="mt-4 pt-1 pb-5 mb-5">
