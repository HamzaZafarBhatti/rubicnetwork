...
@section('title')
Convert Referral Earnings  to Rubic Wallet
@endsection
@section('css')
...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title2')
            Convert Referral Earning to Rubic Wallet
        @endslot
    @endcomponent
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h5 class="text-info">{{ $set->ref_earning_transfer_start_formatted }}</h5>
                    <h5 class="text-info">{{ $set->ref_earning_transfer_end_formatted }}</h5>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Convert Referral Earnings  to Rubic Wallet</h4>
                    <p><strong>Convert your REFERRAL EARNING</strong></p>
<p><span style="color: #008000;"><strong>Convert your REFERRAL Earning to your RUBIC WALLET and Withdraw as Cash to your BANK Weekly.</strong></span></p>
<p>All you have to do is to simply make a Transfer of your <strong>REFERRAL EARNING</strong>&nbsp;to your <span style="background-color: #ffff99; color: #008000;"><strong>RUBIC NGN Wallet</strong></span></p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
