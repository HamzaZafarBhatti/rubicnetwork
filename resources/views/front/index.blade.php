...
@section('content')
                    ...
                    <div class="row">
                            ...
                            <div class="property__grid__single column__space--secondary">
                                <div class="img__effect">
                                    <a href="property-details.html">
                                        <img src="{{ asset('front_assets/images/property/grid-one.jpg') }}"
                                            alt="Property" />
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="property__grid__single column__space--secondary">
                                <div class="img__effect">
                                    <a href="property-details.html">
                                        <img src="{{ asset('front_assets/images/property/grid-two.jpg') }}"
                                            alt="Property" />
                                    </a>
                                </div>
                                <div class="property__grid__single__inner">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="property__grid__single">
                                <div class="img__effect">
                                    <a href="property-details.html">
                                        <img src="{{ asset('front_assets/images/property/grid-three.jpg') }}"
                                            alt="Property" />
                                    </a>
                                </div>
                                <div class="property__grid__single__inner">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="start__single__item column__space--secondary">
                            <div class="img__box arrow__container">
                                <img src="{{ asset('front_assets/images/step/invest.png') }}"
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="platform__thumb thumb__ltr d-none d-lg-block">
                            <img src="{{ asset('front_assets/images/overview/platform-illustration.png') }}"
                                alt="Platform" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="portfolio__overview__single">
                            <img src="{{ asset('front_assets/images/icons/annual-return.png') }}"
    ...
    <section class="portfolio section__space bg__img over__hi"
        data-background="{{ asset('front_assets/images/portfolio-bg.png') }}">
        <div class="container">
        ...
        <div class="container">
            <div class="why__invest__area wow fadeInUp">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-xxl-6">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="why__invest__single shadow__effect__secondary">
                                    <img src="{{ asset('front_assets/images/icons/stable.png') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xxl-3">
                        <div class="why__invest__single shadow__effect__secondary">
                            <img src="{{ asset('front_assets/images/icons/protection.png') }}"
                    ...
                    <div class="col-sm-6 col-xxl-3">
                        <div class="why__invest__single shadow__effect__secondary">
                            <img src="{{ asset('front_assets/images/icons/diversifaction.png') }}"
                                alt="Diversification" />
    ...
    <section class="community section__space__top over__hi bg__img"
        data-background="{{ asset('front_assets/images/community-bg.png') }}">
        <div class="container">
            <div class="community__area">
                ...
                <div class="comunity-wrapper section__space">
                    ...
                    <div class="comunity-area">
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/1.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/2.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/3.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/4.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/5.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/6.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/7.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/8.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/9.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/10.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/11.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/12.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/13.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/14.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/15.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/16.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/17.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/18.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/19.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/22.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/20.png') }}"
                                alt="comunity"></div>
                        <div class="comunity-item"><img src="{{ asset('front_assets/images/community/21.png') }}"
                                alt="comunity"></div>
                    </div>
                            ...
                            <div class="testimonial__author">
                                <div class="testimonial__author__info">
                                    <div class="avatar__wrapper">
                                        <img src="{{ asset('front_assets/images/testimonial/avatar.png') }}"
                                            alt="Allan Murphy" />
                                    </div>
                                    <div>
                                        <h5>Allan Murphy</h5>
