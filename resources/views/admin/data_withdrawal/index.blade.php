            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Data Withdraw logs</h6>
                    </div>
                    <div class="">
                            ...
                            <tbody>
                                @foreach ($withdraw as $k => $val)
                                    <tr>
                                        <td>{{ ++$k }}.</td>
                                        <td><a
                                                href="{{ url('admin/manage-user') }}/{{ $val->user->id }}">{{ $val->user->username }}</a>
                                        </td>
                                                        ...
                                                        @if ($val->status == 0)
                                                            ...
                                                            @else
                                                                <a class='dropdown-item'
                                                                    href="{{ url('/') }}/admin/approvedata_withdraw/{{ $val->id }}"><i
                                                                        class="icon-thumbs-up3 mr-2"></i>Approve request</a>
                                                            @endif
                                                            <a class='dropdown-item'
                                                                href="{{ url('/') }}/admin/declinedata_withdraw/{{ $val->id }}"><i
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ url('/') }}/admin/data_withdraw/delete/{{ $val->id }}"
                                    ...
                                    <div id="{{ $val->id }}pay" class="modal fade" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('data_withdraw.approvemine') }}" method="post">
                                                    @csrf
