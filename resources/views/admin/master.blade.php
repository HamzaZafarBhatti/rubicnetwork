					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="PY scheme">
								...
								<li class="nav-item"><a href="{{route('admin.coupons.index')}}" class="nav-link"><i class="icon-add"></i>Generate Coupons</a></li>
							</ul>
						</li>												
						<li class="nav-item nav-item-submenu">
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-share2"></i><span>Selfcashout system</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Selfcashout">
								<li class="nav-item"><a href="{{route('admin.selfcashout.log')}}" class="nav-link"><i class="icon-list-unordered"></i>Selfcashout log</a></li>
								<li class="nav-item"><a href="{{route('admin.selfcashout.unpaid')}}" class="nav-link"><i class="icon-spinner2 spinner"></i>Unpaid selfcashout</a></li>
								<li class="nav-item"><a href="{{route('admin.selfcashout.approved')}}" class="nav-link"><i class="icon-thumbs-up2"></i>Approved selfcashout</a></li>
								<li class="nav-item"><a href="{{route('admin.selfcashout.declined')}}" class="nav-link"><i class="icon-accessibility"></i>Declined selfcashout</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-share2"></i><span>Paymentproof system</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Paymentproof">
								<li class="nav-item"><a href="{{route('admin.paymentproof.log')}}" class="nav-link"><i class="icon-list-unordered"></i>Paymentproof log</a></li>
								<li class="nav-item"><a href="{{route('admin.paymentproof.pending')}}" class="nav-link"><i class="icon-spinner2 spinner"></i>Pending paymentproof</a></li>
								<li class="nav-item"><a href="{{route('admin.paymentproof.approved')}}" class="nav-link"><i class="icon-thumbs-up2"></i>Approved paymentproof</a></li>
								<li class="nav-item"><a href="{{route('admin.paymentproof.declined')}}" class="nav-link"><i class="icon-accessibility"></i>Declined paymentproof</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-share2"></i><span>Data Operator Withdraw system</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Dataoperator">
								<li class="nav-item"><a href="{{route('admin.data_withdraw.log')}}" class="nav-link"><i class="icon-list-unordered"></i>Data Operator Withdraw log</a></li>
								<li class="nav-item"><a href="{{route('admin.data_withdraw.unpaid')}}" class="nav-link"><i class="icon-spinner2 spinner"></i>Unpaid Data Operator Withdraw</a></li>
								<li class="nav-item"><a href="{{route('admin.data_withdraw.approved')}}" class="nav-link"><i class="icon-thumbs-up2"></i>Approved Data Operator Withdraw</a></li>
								<li class="nav-item"><a href="{{route('admin.data_withdraw.declined')}}" class="nav-link"><i class="icon-accessibility"></i>Declined Data Operator Withdraw</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="News Section">
								...
								<li class="nav-item"><a href="{{route('admin.service')}}"class="nav-link"><i class="icon-portfolio"></i>Services</a></li>
								<li class="nav-item"><a href="{{route('admin.vendors')}}"class="nav-link"><i class="icon-accessibility"></i>Vendors</a></li>
								<li class="nav-item"><a href="{{route('admin.coupons')}}"class="nav-link"><i class="icon-cogs"></i>Coupons</a></li>
