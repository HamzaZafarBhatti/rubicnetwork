                                    ...
                                    <td class="text-center">
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                @if($val->status==0)
                                                    <a class='dropdown-item' href="{{url('/')}}/admin/approveselfcashout/{{$val->id}}"><i class="icon-thumbs-up3 mr-2"></i>Approve request</a>
                                                    <a class='dropdown-item' href="{{url('/')}}/admin/declineselfcashout/{{$val->id}}"><i class="icon-thumbs-down3 mr-2"></i>Decline request</a>
                                                @endif
