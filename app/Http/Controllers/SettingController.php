...
class SettingController extends Controller
{
    ...
    public function SettingsUpdate(Request $request)
    {
        ...
        $data->withdraw_start=$request->withdraw_start;
        $data->withdraw_end=$request->withdraw_end;
        $data->coupon_code_rate=$request->coupon_code_rate;
        $data->monthly_coupon_limit=$request->monthly_coupon_limit;
        $data->selfcashout_amount=$request->selfcashout_amount;
        ...
        $data->data_withdraw_limit=$request->data_withdraw_limit;
        $data->mine_user_limit=$request->mine_user_limit;
        $data->data_user_limit=$request->data_user_limit;
        ...
        if(empty($request->is_testing)){
            ...
            $data->is_testing=$request->is_testing;
        }        
        $res=$data->save();
        if ($res) {
            return back()->with('success', 'Update was Successful!');
