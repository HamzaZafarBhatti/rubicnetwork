    ...
    public function approve($id)
    {
        ...
        if($all){
            ...
            if($set->email_notify==1){
                ...
                Mail::to($user->email)->send(new GeneralEmail($temp->esender, $user->username, 'Deposit of '.$btc.'BTC. has been approved<br>Thanks for working with us.', 'Deposit Request has been approved'));
            }
            if ($res) {
